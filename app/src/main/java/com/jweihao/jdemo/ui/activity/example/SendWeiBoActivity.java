...
import com.jweihao.jdemo.adapter.FullyGridLayoutManager;
import com.jweihao.jdemo.adapter.GridImageAdapter;
...
public class SendWeiBoActivity extends AppCompatActivity {
    ...
    private GridImageAdapter.onAddPicClickListener mOnAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        @Override
        public void onAddPicClick() {
            // 进入相册 以下是例子：不需要的api可以不写
            PictureSelector.create(SendWeiBoActivity.this)
                    ...
                    .selectionMedia(mSelectLists)// 是否传入已选图片
