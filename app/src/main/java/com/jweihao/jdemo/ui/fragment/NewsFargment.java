...
//        recyclerview.addItemDecoration(new DividerItemDecoration(getActivity(),DividerItemDecoration.VERTICAL));
    ...
    private void initDate() {
        ...
        for (int i = 0; i < 50; i++) {
            RecyclerData recyclerData = new RecyclerData(R.mipmap.kl2, "   7月1日，俄罗斯总统普京在与芬兰总统尼尼斯特举行的联合新闻发布会上表示，无论芬兰是否加入北约，俄罗斯都尊重芬兰的选择，但加入北约意味着芬兰国防部队将不再独立，俄罗斯军队也将相应重新进行部署。");
