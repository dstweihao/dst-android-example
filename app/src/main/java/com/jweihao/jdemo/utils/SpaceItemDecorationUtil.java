...
public class SpaceItemDecorationUtil extends RecyclerView.ItemDecoration {
    ...
    public SpaceItemDecorationUtil(Context context) {
        mDisplayMetrics = context.getResources().getDisplayMetrics();
    }

    public SpaceItemDecorationUtil setSpace(int space) {
        mSpace = (int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, space, mDisplayMetrics) + 0.5f);
        return this;
    }

    public SpaceItemDecorationUtil setEdgeSpace(int edgeSpace) {
        mEdgeSpace = (int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, edgeSpace, mDisplayMetrics) + 0.5f);
        return this;
    }

    public SpaceItemDecorationUtil setSpaceColor(int spaceColor) {
